...
module.exports = function(filePath, handle) {
  ...
  lineReader.on('line', line => {
    ...
    let matches = /"(.*?)"/g.exec(d[0]), title = matches !== null ? matches[1] : d[0];
    data.push({
      title: title,
      id: d[2],
      links: {
        download: [],
        magnet: `magnet:?xt=urn:btih:${d[2]}&dn=${encodeURIComponent(title.replace(/\"/g, ''))}&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80&tr=udp%3A%2F%2Fopentor.org%3A2710&tr=udp%3A%2F%2Ftracker.ccc.de%3A80&tr=udp%3A%2F%2Ftracker.blackunicorn.xyz%3A6969&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969`,
        web: []
      },
